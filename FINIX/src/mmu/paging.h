...
#define P3_TABLE        0xffffffffffe00000
#define P2_TABLE        0xffffffffc0000000
#define P1_TABLE        0xffffff8000000000
...
typedef union page_entry {
    uint64_t packed;
    struct {
        uint8_t present : 1;//flag0
        uint8_t writable : 1;//flag1
        uint8_t user_accessable : 1;//flag2
        uint8_t write_thru_cache : 1;//flag3
        uint8_t disable_cache : 1;//flag4
        uint8_t accessed : 1;//flag5
        uint8_t dirty : 1;//flag6
        uint8_t huge_page : 1;//flag7
        uint8_t global : 1;
        uint8_t OS_1 : 1;
        uint8_t OS_2 : 1;
        uint8_t OS_3 : 1;
